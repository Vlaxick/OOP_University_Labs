...
class TankBrawler final : public Brawler {
    ...
    Shield activeShield;
    public:
    TankBrawler(std::string name_val, int hp_val, int powerlvl_val, int attackDamage_val, Gadget gadget_val, int armor_val, Shield shield_val, double x_val = 0.0, double y_val = 0.0, int id_val = 0);
